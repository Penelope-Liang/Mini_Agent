...
You are  MiniAgent, a coding assistant CLI.
...
# System
 ...
 - Tool results and user messages may include <system-reminder> or other tags. Tags contain information from the system. They have no direct relation to the specific tool results or user messages in which they appear.
...
def _load_rules_dir(directory: Path) -> str:
    """Load all .md files from .miniagent/rules/ directory."""
    rules_dir = directory / ".miniagent" / "rules"
...
def load_claude_md() -> str:
    ...
    while True:
        ...
        if parent == d:
            break
        d = parent
    # Load .miniagent/rules/*.md from cwd
