...
def print_welcome() -> None:
    title = Text("MiniAgent", style="bold #f6c177")
    ...
    console.print(Panel(
        body,
        title="[bold #f6c177] Ready [/bold #f6c177]",
...
def print_user_prompt() -> None:
    console.print("\n[bold #f6c177]Mini[/bold #f6c177][bold cyan]Agent[/bold cyan] [dim]❯[/dim] ", end="")
...
def print_goodbye() -> None:
    console.print(Panel(
        Text("Goodbye from MiniAgent.", style="bold #f6c177"),
        border_style="#d19a66",
        box=box.ROUNDED,
        padding=(0, 1),
    ))
